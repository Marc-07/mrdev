                ...
                <div className="max-w-5xl mx-auto px-4 flex flex-col lg:flex-row items-start gap-10">
                    ...
                    <div className="w-full lg:w-3/4">
                        ...
                        <div className="mt-8 w-full text-center lg:text-left">
                            <a
                                href="/mrdev/CurriculoMariaR.pdf"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-block px-6 py-3 border-2 border-purple-600 text-purple-600 font-semibold rounded-lg hover:bg-purple-600 hover:text-white transition-colors duration-400"
                            >
                                Ver Currículum
                            </a>
                        </div>
